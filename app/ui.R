    ...
    navbarPage("PaIRKAT",
               tabPanel("About",
                        ...
                        p("PaIRKAT is model framework for assessing statistical relationships between networks of 
                          metabolites (pathways) and some outcome of interest. PaIRKAT queries the KEGG database to determine interactions between metabolites
                        ...
                        tags$ol(
                          tags$li("Upload Data",
                                  ...
                                  tags$ol(
                                    tags$li("Phenotype Data: Contains outcomes of interest and any meaningful covariates to be adjusted for. Rows should be subjects and columns should be variables."),
                          ...
                          tags$li("Run PaIRKAT"),
                          p("Define outcome of interest and covaraites to control for. Output from this analysis is a list of significant pathways associated with the outcome of interest."),
                        ...
                        tags$ul(
                          tags$li("Rows of phenotype data and metabolite measurements with missing data should be removed or imputed."),
                          tags$li("Metabolite measurements should be normalized."),
                          tags$li("Metabolite measurements and phenotype data should both have a subject ID column with the same name for merging."),
               ...
               tabPanel("Pathways",
                        sidebarPanel(h4("Gather Pathways"),
                                     ...
                                     helpText('Column in metabolitte measurements and phenotype data with subject IDs (should be the same column name in both).'),
               ...
               tabPanel("PaIRKAT",
                        sidebarPanel(
                          ...
                          bsTooltip(id = "Y", title = "Select a variable with which to associate metabolites", placement = "bottom", trigger = "hover",
                                    options = NULL),
                          selectInput("X", "Adjust for Covariates", choices = NULL, multiple = T),
                        ...
                        mainPanel(
                          ...
                          "Adjusted Covariates: ",textOutput("pKatX"),
                          h3("Results"),
                          tabsetPanel(
                                                                  ...
                                                                  bsCollapsePanel("Data", 
                                                                                  selectInput("plotData", "Data Set",
                                                                                              c(
                                                                                                ...
                                                                                                "Phenotype/Metabolite Data" = "clinical"
                                                                                              )),
